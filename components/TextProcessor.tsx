      ...
      <div className="p-4 md:p-6 space-y-4">
              ...
              <div className="flex items-center gap-2">
                {isPasteReady && (
                  <button
                    ...
                    className="p-2 rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 focus-visible:ring-blue-400 bg-gray-700 text-gray-300 hover:bg-gray-600 disabled:opacity-50"
        ...
        <div className="flex justify-center -my-1">
             <button
              ...
              className="group flex items-center justify-center gap-2 px-4 py-2 bg-gray-800 border border-gray-700 rounded-full disabled:opacity-50 disabled:cursor-not-allowed transition-colors hover:border-red-700/60 hover:bg-red-900/50"
              aria-label={t('processor.prompts.clearAll')}
            >
              <Icon 
                name="trash" 
                className={`w-5 h-5 transition-colors ${hasContent ? 'text-red-500 group-hover:text-white' : 'text-gray-500'}`} 
              />
              <span className={`transition-colors font-medium ${hasContent ? 'text-gray-300' : 'text-gray-500'}`}>
                {t('processor.prompts.clearAll')}
              </span>
            </button>
        </div>
