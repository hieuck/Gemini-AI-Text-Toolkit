...
const App: React.FC = () => {
  ...
  // Fix: Removed API key state management and logic to adhere to guidelines.
  // This also resolves the "Cannot find name 'chrome'" error.
  ...
  // Fix: Removed API key loading and input UI. The app now assumes the API key is set in the environment.
  return (
    <div className="flex flex-col h-screen antialiased bg-gray-900 text-gray-100">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          {/* Fix: Removed apiKey prop as it's no longer needed. */}
